...
provides:
  ...
  - "Module renamed to github.com/doxazo-net/canticle"
...
key-decisions:
  - "Module renamed from github.com/fashni/mxlrc-go to github.com/doxazo-net/canticle"
...
**Module renamed to github.com/doxazo-net/canticle with internal/models (7 data types) and internal/app (InputsQueue) packages created**
...
## Accomplishments
- Go module renamed from github.com/fashni/mxlrc-go to github.com/doxazo-net/canticle
...
- `go.mod` - Module path renamed to github.com/doxazo-net/canticle
