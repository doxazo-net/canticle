...
| Module path rename | `go.mod` says `github.com/fashni/mxlrc-go`. Fork identity requires `sydlexius/mxlrcgo-svc`. All import paths change. | Low | `go mod edit -module github.com/doxazo-net/canticle`, then fix all import statements. |
